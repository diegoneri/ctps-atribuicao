 ...
 */
@Component
public class CategoriaProfessorView1 extends javax.swing.JInternalFrame {
    ...
    public CategoriaProfessorView1() {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            try {
                ...
                Logger.getLogger(CategoriaProfessorView1.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoriaProfessorView1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CategoriaProfessorView1().setVisible(true);
            }
        });
    }
