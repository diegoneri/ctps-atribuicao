 ...
 */
@Component
public class TipoAtribuicaoView extends javax.swing.JInternalFrame {

    /**
     * Método construtor da classe PrincipalAtribuicaoView
     */
    private TipoAtribuicaoDao dao = new TipoAtribuicaoDao();
    private Integer PAGE = 1;
    private Integer TOTAL_RECORDS = dao.getCount();
    private Operacao operacao = Operacao.NENHUM;

    public TipoAtribuicaoView() {
        initDataList();
        initComponents();
        firstPage();
        enableFields(false);
    ...
    private void doPagination(int page) {
        this.PAGE = page;
        this.listTipoAtribuicao.clear();
        this.listTipoAtribuicao.addAll(dao.listAll(Utils.PAGE_SIZE , page));
        ...
        if (listTipoAtribuicao.size() > 0) {
            this.tbTipoAtribuicao.setRowSelectionInterval(0 , 0);
        }
    ...
    private void initComponents() {
        ...
        listTipoAtribuicao = listTipoAtribuicao;
        tipoAtribuicaoBean = new br.com.etec.model.TipoAtribuicao();
        paneltitulo = new javax.swing.JPanel();
        lblTitulo = new javax.swing.JLabel();
        panelTable = new javax.swing.JPanel();
        scrollTable = new javax.swing.JScrollPane();
        tbTipoAtribuicao = new javax.swing.JTable();
        tbTipoAtribuicao.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            @Override
            public void valueChanged(ListSelectionEvent evt) {
                if (tbTipoAtribuicao.getSelectedRow() != -1) {
                    tipoAtribuicaoBean = listTipoAtribuicao.get(tbTipoAtribuicao.getSelectedRow());
                    btnAlterar.setEnabled(Boolean.TRUE);
                    btnExcluir.setEnabled(Boolean.TRUE);
                } else {
                    tipoAtribuicaoBean = null;
        ...
        lblTitulo.setText("Tipos de Atribuicao");
        ...
        tbTipoAtribuicao.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listTipoAtribuicao, tbTipoAtribuicao);
        ...
        jTableBinding.bind();
        scrollTable.setViewportView(tbTipoAtribuicao);
        tbTipoAtribuicao.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        tbTipoAtribuicao.getColumnModel().getColumn(0).setResizable(false);
        tbTipoAtribuicao.getColumnModel().getColumn(0).setPreferredWidth(50);
        tbTipoAtribuicao.getColumnModel().getColumn(1).setResizable(false);
        tbTipoAtribuicao.getColumnModel().getColumn(1).setPreferredWidth(250);
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tbTipoAtribuicao, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.id}"), txtId, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tbTipoAtribuicao, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nome}"), txtNome, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        this.initFields(tbTipoAtribuicao.getSelectedRow() , Operacao.ALTERAR);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        switch (operacao) {
            case INCLUIR:
                dao.create(tipoAtribuicaoBean);
                break;
            case ALTERAR:
                dao.update(tipoAtribuicaoBean);
                break;
            default:
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        dao.getEntityManager().getTransaction().begin();
        dao.refresh(tipoAtribuicaoBean);
        dao.getEntityManager().getTransaction().commit();
        this.initFields(-1 , Operacao.NENHUM);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        int resposta =
                JOptionPane.showConfirmDialog(this , "Deseja excluir o tipo de contrato " + tipoAtribuicaoBean.getNome() + "?" , "Exclusão" , JOptionPane.YES_NO_OPTION , JOptionPane.QUESTION_MESSAGE);
        if (resposta == JOptionPane.YES_OPTION) {
            try {
                dao.getEntityManager().getTransaction().begin();
                dao.delete(tipoAtribuicaoBean);
                dao.getEntityManager().getTransaction().commit();
                this.listTipoAtribuicao.remove(tipoAtribuicaoBean);
                this.initFields(-1 , Operacao.NENHUM);
            } catch (Exception ex) {
                Logger.getLogger(TipoAtribuicaoView.class.getName()).log(Level.SEVERE , null , ex);
            }
        }
    }//GEN-LAST:event_btnExcluirActionPerformed

    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        this.listTipoAtribuicao.add(new TipoAtribuicao());
        this.initFields(this.listTipoAtribuicao.size() - 1 , Operacao.INCLUIR);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoAtribuicaoView.class.getName()).log(java.util.logging.Level.SEVERE , null , ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TipoAtribuicaoView().setVisible(true);
            }
        });
    }
    ...
    private java.util.List<TipoAtribuicao> listTipoAtribuicao;
    private javax.swing.JPanel panelDados;
    private javax.swing.JPanel panelTable;
    private javax.swing.JPanel paneltitulo;
    private javax.swing.JScrollPane scrollTable;
    private javax.swing.JTable tbTipoAtribuicao;
    private br.com.etec.model.TipoAtribuicao tipoAtribuicaoBean;
    ...
    private void initDataList() {
        this.listTipoAtribuicao = ObservableCollections.observableList(new ArrayList<TipoAtribuicao>());
    }
    ...
    private void initFields(int row , Operacao operacao) {
        ...
        if (operacao == Operacao.NENHUM) {
            ...
            int index = tbTipoAtribuicao.getSelectedRow();
            tbTipoAtribuicao.getSelectionModel().clearSelection();
            clearFields();
            if (index < 0) {
                index = 0;
            }
            this.tbTipoAtribuicao.setRowSelectionInterval(index , index);
            this.TOTAL_RECORDS = dao.getCount();
            this.doPagination(PAGE);
            this.enableFields(false);
        } else {
            //INCLUIR E ALTERAR
            tbTipoAtribuicao.setRowSelectionInterval(row , row);
            tbTipoAtribuicao.scrollRectToVisible(tbTipoAtribuicao.getCellRect(row , 0 , true));
    ...
    private void enableFields(boolean flag) {
        ...
        this.tbTipoAtribuicao.setEnabled(!flag);
